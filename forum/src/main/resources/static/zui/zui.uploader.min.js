...
!function (e, t) {
    ...
    !function (e, t) {
        ...
        n("moxie/core/utils/Basic", [], function () {
                ...
                var t = "", i = "?", n = "function", r = "undefined", o = "object", a = "name", s = "version", l = {
                    ...
                    rgx: function () {
                        ...
                        for (var r in n) if (typeof n[r] === o && n[r].length > 0) {
                            for (var a = 0; a < n[r].length; a++) if (l.has(n[r][a], t)) return r === i ? e : r
            ...
            function r(e, n, o, s, l) {
                var u, c = this, d = t.guid(n + "_"), p = l || "browser";
            ...
            function u(t) {
                var o, u, d;
                if (-1 !== e.inArray(e.typeOf(t), ["string", "node"]) && (t = {browse_button: t}), u = n.get(t.browse_button), !u) throw new r.DOMException(r.DOMException.NOT_FOUND_ERR);
                d = {
            ...
            var t = function (i, n) {
                var r,
                    ...
                    a = o.length, s = {http: 80, https: 443}, l = {},
                    u = /^(?:([^:\/?#]+):)?(?:\/\/()(?:(?:()(?:([^:@\/]*):?([^:@\/]*))?@)?(\[[\da-fA-F:]+\]|[^:\/?#]*)(?::(\d*))?))?()(?:(()(?:(?:[^?#\/]*\/)*)()(?:[^?#]*))(?:\\?([^#]*))?(?:#(.*))?)/,
                    c = u.exec(i || ""), d = /^\/\/\w/.test(i);
                switch (e.typeOf(n)) {
                    case"undefined":
            ...
            function f() {
                ...
                function l(t) {
                    ...
                    var s = this;
                    b = (new Date).getTime(), _ = new a, "string" == typeof B.required_caps && (B.required_caps = o.parseCaps(B.required_caps)), B.required_caps = e.extend({}, B.required_caps, {return_response_type: s.responseType}), t instanceof u && (B.required_caps.send_multipart = !0), e.isEmptyObj(A) || (B.required_caps.send_custom_headers = !0), z || (B.required_caps.do_cors = !0), B.ruid ? r(_.connectRuntime(B)) : (_.bind("RuntimeInit", function (e, t) {
                        r(t)
                ...
                var v, x, E, y, b, w, _, R, I = this, S = {
                        ...
                        responseText: null,
                        response: null
                    }, T = !0, A = {}, O = null, D = null, F = !1, C = !1, N = !1, L = !1, M = !1, z = !1, U = null,
                    P = null, B = {}, k = "";
                e.extend(this, S, {
                    uid: e.guid("uid_"), upload: new p, open: function (o, a, s, l, u) {
                        ...
                        if (B = "string" === e.typeOf(r) ? {ruid: r} : r ? r : {}, this.readyState !== f.OPENED || C) throw new t.DOMException(t.DOMException.INVALID_STATE_ERR);
                        if (i instanceof s) B.ruid = i.ruid, D = i.type || "application/octet-stream"; else if (i instanceof u) {
                            if (i.hasBlob()) {
                                var o = i.getBlob();
                        ...
                        if (M = !0, F = !1, ~e.inArray(i("readyState"), [f.UNSENT, f.OPENED, f.DONE])) i("readyState", f.UNSENT); else {
            ...
            function r() {
                ...
                i.call(this), e.extend(this, {
                    ...
                    transport: function (t, i, r) {
                        var a = this;
                        if (r = e.extend({chunk_size: 204798}, r), (s = r.chunk_size % 3) && (r.chunk_size += 3 - s), p = r.chunk_size, n.call(this), u = t, c = t.length, "string" === e.typeOf(r) || r.ruid) o.call(a, i, this.connectRuntime(r)); else {
                            var l = function (e, t) {
            ...
            function f() {
                ...
                function u(t) {
                    ...
                    try {
                        ...
                        } else if (-1 !== e.inArray(n, ["blob", "file"])) u.call(this, new d(null, t), arguments[1]); else if ("string" === n) "data:" === t.substr(0, 5) ? u.call(this, new c(null, {data: t}), arguments[1]) : v.apply(this, arguments); else {
                ...
                a.call(this), e.extend(this, {
                    ...
                    embed: function (n, r) {
                        function o(t, r) {
                            ...
                            if (l.can("use_data_uri_of", d.length)) n.innerHTML = '<img src="' + d + '" width="' + o.width + '" height="' + o.height + '" alt="" />', o.destroy(), u.trigger("embedded"); else {
                                var f = new s;
            ...
            function o(t) {
                var o = this, l = i.capTest, u = i.capTrue, c = e.extend({
            ...
            var n = {}, r = "moxie_" + e.guid(), o = function (o, a, s, l) {
                var u, c;
            ...
            function s() {
                ...
                i.extend(this, {
                    init: function (l) {
                        var u, c, d, p, f, m, h = this, g = h.getRuntime();
                        ...
                        var t = this.getRuntime(), i = t.getShim(), o = t.getShimContainer(),
                            a = e && n.get(e.container), l = e && n.get(e.browse_button);
            ...
            function u() {
                function e(e, t) {
                    ...
                    i = t.getBlob().getSource(), n = new window.FileReader, n.onload = function () {
                        t.append(t.getBlobName(), new o(null, {type: i.type, data: n.result})), m.send.call(r, e, t)
                ...
                t.extend(this, {
                    send: function (i, r) {
                        var s = this,
                            ...
                            m = "Android Browser" === l.browser, h = !1;
                        if (f = i.url.replace(/^.+?\/([\w\-\.]+)$/, "$1").toLowerCase(), p = u(), p.open(i.method, i.url, i.async, i.user, i.password), r instanceof o) r.isDetached() && (h = !0), r = r.getSource(); else if (r instanceof a) {
                            if (r.hasBlob()) if (r.getBlob().isDetached()) r = d.call(s, r), h = !0; else if ((c || m) && "blob" === t.typeOf(r.getBlob().getSource()) && window.FileReader) return void e.call(s, i, r);
                            if (r instanceof a) {
            ...
            function r(o) {
                function a(i, r) {
                    var o, a, s, l, u, p, f, m, h = this, g = [], v = {}, x = {
                        ...
                        9: "SLONG",
                        10: "SRATIONAL"
                    }, E = {BYTE: 1, UNDEFINED: 1, ASCII: 1, SHORT: 2, LONG: 4, RATIONAL: 8, SLONG: 4, SRATIONAL: 8};
                ...
                }, d = {tiffHeader: 10}, p = d.tiffHeader, l = {clear: this.clear}, e.extend(this, {
                    read: function () {
                        try {
            ...
            function u() {
                ...
                t.extend(this, {
                    loadFromBlob: function (e) {
                        ...
                        })) : new o(null, {name: y.name || "", type: e, data: b.getAsBinaryString(e, t)})
                        ...
                        if ("image/jpeg" !== e) E = c(b.getAsDataURL(e, t)); else {
                            var i;
                            t || (t = 90), u();
                            try {
            ...
            function u(l) {
                var u, p = this;
                l = e.extend({swf_url: t.swf_url}, l), o.call(this, l, c, {
            ...
            function s(s) {
                var c, d = this;
                s = e.extend({xap_url: t.xap_url}, s), o.call(this, s, l, {
            ...
            function s() {
                function e() {
                    ...
                    m = i.guid("uid_"), o = g.getShimContainer(), s && (d = n.get(s + "_form"), d && (i.extend(d.style, {top: "100%"}), d.firstChild.setAttribute("tabindex", -1))), p = document.createElement("form"), p.setAttribute("id", m + "_form"), p.setAttribute("method", "post"), p.setAttribute("enctype", "multipart/form-data"), p.setAttribute("encoding", "multipart/form-data"), i.extend(p.style, {
                        overflow: "hidden",
                        position: "absolute",
                        top: 0,
                        left: 0,
                        ...
                        width: "100%",
                        height: "100%"
                    }), "IE" === a.browser && a.verComp(a.version, 10, "<") && i.extend(f.style, {filter: "progid:DXImageTransform.Microsoft.Alpha(opacity=0)"}), f.onchange = function () {
                        var i;
                ...
                i.extend(this, {
                    init: function (t) {
                        ...
                        l = t, c = o.extList2mimes(t.accept, s.can("filter_by_extension")), i = s.getShimContainer(), function () {
                            var e, o, c;
                        ...
                        var e = this.getRuntime(), t = e.getShim(), i = e.getShimContainer(),
                            o = l && n.get(l.container), a = l && n.get(l.browse_button);
            ...
            function l() {
                ...
                t.extend(this, {
                    send: function (d, p) {
                        function f() {
                            var i = E.getShimContainer() || document.body, r = document.createElement("div");
        ...
        l.addFileFilter("mime_types", function (e, t, i) {
            ...
            function f(e, i) {
                ...
                l.each(e.runtimes.split(/\s*,\s*/), function (t) {
                    ...
                    o.push(function (i) {
                        var o = new t.file.FileDrop(l.extend({}, a, {drop_zone: e}));
                        o.onready = function () {
                            var e = s.getInfo(this.ruid);
                            l.extend(n.features, {
                                chunks: e.can("slice_blob"),
            ...
            function h(e, i, r) {
                function o(e, i, n) {
                    ...
                    switch (e) {
                        ...
                        case"unique_names":
                            ...
                            break;
                        case"filters":
                            "array" === l.typeOf(i) && (i = {mime_types: i}), n ? l.extend(R.filters, i) : R.filters = i, i.mime_types && ("string" === l.typeOf(i.mime_types) && (i.mime_types = t.core.utils.Mime.mimes2extList(i.mime_types)), i.mime_types.regexp = function (e) {
                                var t = [];
                            ...
                            break;
                        case"resize":
                            R.resize = !!i && l.extend({preserve_headers: !0, crop: !1}, i);
                            break;
                ...
                "object" == typeof e ? l.each(e, function (e, t) {
                    o(t, e, r)
                }) : o(e, i, r), r ? (R.required_features = n(l.extend({}, R)), D = n(l.extend({}, R, {required_features: !0}))) : u && (a.trigger("Destroy"), f.call(a, R, function (e) {
                    e ? (a.runtime = s.getInfo(d()).type, a.trigger("Init", {runtime: a.runtime}), a.trigger("PostInit")) : a.trigger("Error", {
                        code: l.INIT_ERROR,
            ...
            function v(e, i) {
                ...
                var s, u = e.settings.url, c = e.settings.chunk_size, d = e.settings.max_retries, p = e.features, f = 0,
                    h = {
            ...
            function E(e) {
                if (e.state == l.STARTED) I = +new Date; else if (e.state == l.STOPPED) for (var t = e.files.length - 1; t >= 0; t--) e.files[t].status == l.UPLOADING && (e.files[t].status = l.QUEUED, c())
            }
            ...
            R = {
                ...
                init: function () {
                    ...
                    return e = i.getOption("preinit"), "function" == typeof e ? e(i) : l.each(e, function (e, t) {
                        ...
                        "function" == typeof t ? t(i) : l.each(t, function (e, t) {
                            i.bind(t, e)
                        }), e ? (i.runtime = s.getInfo(d()).type, i.trigger("Init", {runtime: i.runtime}), i.trigger("PostInit")) : i.trigger("Error", {
                            code: l.INIT_ERROR,
                            message: l.translate("Init error.")
                        })
                    }) : i.trigger("Error", {
                ...
                removeFile: function (e) {
                    for (var t = "string" == typeof e ? e : e.id, i = O.length - 1; i >= 0; i--) if (O[i].id === t) return this.splice(i, 1)[0]
                },
                splice: function (e, t) {
                    var n = O.splice(e === i ? 0 : e, t === i ? O.length : t), r = !1;
    ...
    var o = e.zui.browser && e.zui.browser.ie && e.zui.browser.ie < 11, a = "zui.uploader",
    ...
    var c = {
        ...
        if (o) y.attr("data-drop-placeholder", ""); else {
        ...
        u.$dropElement = y, u.$message = f.find(".uploader-message").on("click", ".close", function () {
            ...
            var n = e(this).closest(".file"), r = n.data("file"), o = l.deleteActionOnDone,
            ...
            var t = e(this).closest(".file"), n = u.plupload.getFile(t.data("id")) || t.data("file");
            ...
            if (!t.hasClass("file-renaming")) {
                var n = u.plupload.getFile(t.data("id")) || t.data("file"), o = l.renameActionOnDone,
            ...
            n = e.extend({status: i.DONE}, n), n["static"] = !0, n.id || (n.id = e.zui.uuid()), u.showFile(n), n.size && (u.staticFilesSize += n.size, u.staticFilesCount++)
        }), u.callEvent("onInit")
    };
    d.DEFAULTS = l, d.prototype.showMessage = function (e, t, i) {
        ...
        if (t && t.getSource && /image\//.test(t.type)) {
            var r = e.extend({width: 200, height: 200}, this.options.previewImageSize);
            if ("image/gif" == t.type) {
        ...
        var t = e.type, i = e.ext, n = "file-o", r = t ? t.split("/") : null, o = r && r.length ? r[0] : "",
            a = (r && r.length) > 1 ? r[1] : "";
        ...
        if ("string" == typeof t && (t = r.plupload.getFile(t)), t) {
            ...
            if (o && o.length) {
                ...
                if (a.fileFormater) a.fileFormater.call(r, o, t, s); else {
        ...
        if (t.options.statusCreator) s = t.options.statusCreator(a, o, t); else {
            var u = {
        ...
        var n = this, o = n.options, a = e.extend({}, o, {
            ...
            FilesAdded: function (e, t) {
                ...
                if (i) {
                    ...
                    if (r + t.length > i) {
                        n.showMessage(n.lang.limitFilesCountMessage.format({count: i}), "warning");
                ...
                if (c) {
                    var d = null;
                    if (e.isFunction(c)) d = c.call(n, s, a); else if (s.response) {
                        var p = a.remoteData;
                    ...
                    if (d) return d = e.isPlainObject(d) ? d : {message: d}, a.status = i.FAILED, d.code === r && (d.code = i.GENERIC_ERROR), d.file = a, d.responseObject = s, void(a.errorMessage = d.message)
                }
                ...
                if (a) {
                    ...
                    var c = u && u.length ? "<p>" + u.join(",") + "</p>" : "", d = {uploaded: s, failed: l};
        ...
        return this.options = e.extend({lang: e.zui.clientLang()}, l, this.$.data(), t), this.options
        ...
        return this.each(function () {
            var n = e(this), r = n.data(a), o = "object" == typeof t && t;
